 ...
 */
@HolderType(cellType = 5)
public class SubViewHolder5 extends JsonAutoWindViewHolder {
    ...
    public SubViewHolder5(@NonNull ViewGroup parenetView) {
        super(parenetView, R.layout.view_holder_5_layout);
    }
